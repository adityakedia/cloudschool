...
$(function () {
    var pagination = ['v-pills-setup-tab', 'v-pills-document-tab', 'v-pills-code-tab', 'v-pills-image-tab', 'v-pills-openai-image-tab', 'v-pills-stable-diffusion-image-tab', 'v-pills-bad-word-tab', 'v-pills-voiceover-tab', 'v-pills-speech-tab', 'v-pills-access-tab'];
